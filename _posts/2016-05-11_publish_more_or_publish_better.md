...
A couple of month ago, I was discussing with senior colleagues about the conditions to (have a chance to) be tenured. One of them told that the first thing the evaluation committee will look at will be my [h-index.]() He also told me that, below a h-index of 10, I have few chances to even be *considered*. He admitted it to be bad, but that it the case anyway...

I am not a defender of the h-index, on the contrary. I have been an [ImpactStory advisor](http://blog.impactstory.org/advisor-month-lobet/) for quite some time now and I advocate for the [valorisation of every scientific outputs](www.guillaumelobet.be/science_valorisation/). So it depressed me a little to know that the h-index was still so strongly used by evaluation committees.
...
So to conclude, this small exercice did not teach me anything really knew. It just put some hard-cold number on the reality: to increase your h-index, you need papers, and citations (that's the very definition of the index). So publish more and better, or punish more and cite yourself...

The hard part is that in order to be able to continue to do research (and we all know that science is not getting more money these days), you have to publish papers quickly, early in your career. A direct consequence is that placing a lot of weight on the h-index in evaluation boards encourages young researchers to minimise risk when writing projects (maybe more on that later). You can hardly afford a couple of years without any papers. 

Fortunately, the h-index is not King everywhere. I heard many stories where it was used only for what it is: merely an indicator. Let's hope it stays that way. For me, the predictor told me that, based on my current production, I will reach my goal in 2018... We'll see how it goes. 

> Many thanks to [Stacy Konkiel](skonkiel) for her comments on advice on this post!
